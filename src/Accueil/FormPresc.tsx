...
import { apiMedecins, apiPresc } from "../Helpers/Api";
const FormPresc: React.FC = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        const response = await axios.post(`${apiPresc}`, values, {
          headers: {
        ...
        <div>
          <div className="input-container">
            ...
            <textarea
              className="px-4 py-3 border-0 shadow-none"
              style={{ height: "120px" }}
              placeholder={`${t("modal.form-msg-presc")}`}
              name="message"
